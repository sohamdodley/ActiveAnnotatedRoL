...
if stage == "Survey":
    ...
    **Survey** (Diana Ridley, Chapter 4)  
    Skim the **entire** article on the left. Write your gist on the right at the same time.  
    Focus on title, headings, opening and closing sections, and overall structure.
    """)
    ...
    # Parallel layout: article left, gist right
    ...
    with col_right:
        ...
        st.session_state.survey_gist = st.text_area(
            ...
            key="survey_gist_input",
        )
        st.caption("You can scroll the article and write at the same time.")
